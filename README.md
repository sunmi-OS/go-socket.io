...
[![GoDoc](http://godoc.org/github.com/sunmi-OS/go-socket.io?status.svg)](http://godoc.org/github.com/sunmi-OS/go-socket.io) [![Build Status](https://travis-ci.org/sunmi-OS/go-socket.io.svg)](https://travis-ci.org/sunmi-OS/go-socket.io)

**Please use v1.4 branch.in/sunmi-OS/go-socket.io.v1". I have no time to maintain master branch now**
...
```bash
go get github.com/sunmi-OS/go-socket.io
```

Import it with:

```go
import "github.com/sunmi-OS/go-socket.io"
```
...
import (
	...
	"github.com/sunmi-OS/go-socket.io"
)
